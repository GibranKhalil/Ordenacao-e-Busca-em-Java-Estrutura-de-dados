...
public class ListaLigada {
	...
	public void adicionarNoComeco(Customer novoElemento) {
	...
	public void adicionarNoFinal(Customer novoElemento) {
	...
	public void adicinarNaPosicao(Customer novoElemento, int posicao) {
	...
	public Customer pegar(int posicao) {

		return pegarCelula(posicao).getElemento();

	}

	public boolean contem(int elementoBuscado) {

		Celula atual = primeiraCelula;

		while (atual != null) {

			if (atual.getElemento().getId() == (elementoBuscado)) {
				return true;
			}
			atual = atual.getProximo();
		}
	...
	//Função criada para retornar codigo do elemento.
	public int contemCliente(int elementoBuscado) {
		...
		while (atual != null) {
			...
			if (atual.getElemento().getId() == (elementoBuscado)) {
				return atual.getElemento().getId();
			}
			atual = atual.getProximo();
		}
